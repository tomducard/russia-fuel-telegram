...
python scripts/enrich_dataset.py --input data/interim/daily_features.parquet --output data/processed/merged_enriched.parquet
...
python -m rft.cli train --data data/processed/merged_enriched.parquet --mode classification --model-type rf --target crisis_7d

# 4b. LSTM (Deep Learning)
echo "   > Training LSTM (Sequence Model)..."
python -m rft.cli train --data data/processed/merged_enriched.parquet --mode classification --model-type lstm --target crisis_7d
